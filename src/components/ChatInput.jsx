...
export default function ChatInput({ onSend, disabled }) {
  ...
  async function handleFileChange(e) {
    ...
    try {
      ...
      setImagePreview({ dataUrl, mimeType: file.type || 'application/octet-stream', fileName: file.name })
    } catch {
        ...
        <>
          ...
          <div className="image-preview-row">
            {imagePreview.mimeType === 'application/pdf' ? (
              <svg className="image-preview-thumb pdf-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
